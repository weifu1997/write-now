...
export const WORKFLOW_STEP_CATALOG: readonly WorkflowStepCatalogEntry[] = [
  ...
  },
  {
    ...
    label: "生成卷拆章列表",
    targetType: "novel",
    reads: ["volume_strategy", "character_cast", "volume_beat_sheet"],
    writes: ["volume_chapter_list"],
    mayModifyUserContent: true,
    requiresApprovalByDefault: false,
    supportsAutoRetry: true,
  ...
  },
  {
    ...
    label: "细化章节任务单与执行资源",
    targetType: "novel",
    reads: ["volume_strategy", "character_cast", "volume_beat_sheet", "volume_chapter_list"],
