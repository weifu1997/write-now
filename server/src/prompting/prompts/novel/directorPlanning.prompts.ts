...
> = {
  ...
  render: (input, context) => [
    new SystemMessage([
      ...
      "4. chapter3Payoff、chapter10Payoff、chapter30Payoff 必须体现明确的连载兑现节奏，说明在对应阶段读者能拿到什么阶段性满足。字段名保持这三个，但截止章必须服从上下文中的平台早期兑现窗；开书主矛盾不得拖到开篇弧之后。",
      ...
      "",
      "【质量要求】",
      "1. chapter3Payoff 应偏向开书抓手与快速兑现，对应抓手章窗口。",
      "2. chapter10Payoff 应体现中前段建立后的第一阶段回报或局面变化，对应第一阶段窗口。",
      "3. chapter30Payoff 应体现开篇弧内的阶段承诺兑现，对应开篇弧窗口，不得把开书主矛盾放到该窗口之后。",
