...
- 选好目标平台后，新书会按该平台习惯给出默认章长、开篇进入冲突的速度，以及前几章该兑现到哪；番茄免费默认约 2000 字一章，起点和晋江仍约 2800 字。
- 你手填过的章长会保留；番茄书如果勾选无限流、诸天万界、黑科技这类不合标签，保存时会拦住并给出可改方向。
- 前几章更强调当场动作和选择；单章过长会先压缩再补写，不会自动拆成两章。
- 全书自动创作到达你设定的目标章数后会收束，不会再为了补几章而拆出一整卷新的终局。
